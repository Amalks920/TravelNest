...
import { Link } from "react-router-dom";
  ...
  const TABLE_HEAD = ["SL NO", "ID", "USERNAME", "EMIAL","PHONE", "STATUS", "",""];
  ...
  export function UsersList() {
    ...
    const {data:users,isError,isFetching,isLoading,isSuccess}=useGetAllUserQuery()
    console.log(users)
    return (
      ...
      //       <tbody>
      //         {users.map(
      //           ({ _id, username, email, phone, isBlocked, role }, index) => {
                ...
                return (
                  <tr key={_id}>
                    ...
                    <td className={classes+" "+'border-r-2'}>
                      <div className="w-max">
                        <Chip
                          ...
                          value={isBlocked===true ? "Blocked" : "Not Blocked"}
                    ...
                    <Typography
                        ...
                        className="font-normal"
                      >
                       <Link to={`/admin/user-details/${_id}`} className="text-[0.56rem] text-center">View Details</Link>
                      </Typography>
                    </td>
                    <td className={classes}>
                      <Tooltip content="Edit User">
