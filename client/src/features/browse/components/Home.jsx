...
<div className="absolute row-span-1 h-[270px] col-span-full w-[100vw]  bg-cover flex flex-col justify-center items-center -ms-2 -mt-5"
       style={{backgroundImage:`url(${'https://assets.oyoroomscdn.com/cmsMedia/115d178d-ef59-4212-a6ed-953eb4ce8241.jpg'})`}}>
          <SearchSectionHome/>

        </div>

        <div className="row-span-1 h-[300px] mt-[300px] ms-[90px] border-2 col-span-full w-[90%] bg-cover" style={{backgroundImage:`url(${'https://assets.oyoroomscdn.com/cmsMedia/6e9d9804-9c6f-4b18-a5d5-5e9a8f9815e5.jpg'})`}}>
         ...
         >
          ...
          hotels?.map(
            ({ _id, hotelName, price, description, images }, index) => (
              <div
                key={_id}
                className={`${index<=3 && 'mt-[500px]'} col-span-2 lg:col-span-2  mb-[50px]   xl:col-span-1`}
              >
                <Cards
                  hotel_id={_id}
                  hotelName={hotelName}
