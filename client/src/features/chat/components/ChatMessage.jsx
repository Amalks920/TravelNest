          ...
          <div className={`col-span-1 
           ...
           mb-3 rounded-s-lg`}></div>      
            <div className={`col-span-1 p-3    mb-3 rounded-e-lg  w-[100%] hover:shadow-md `}>
              <h2 className={`text-center text-[0.9rem] text-gray-500  w-full`}>{formatDate( updatedAt)}</h2>
              <div className="flex">
              <h2 className={`font-bold  p-1 capitalize text-[1rem]`}>{sender.username} <span className="text-[0.6rem] font-extralight"></span></h2>
              <h3 className="text-[0.7rem] mt-3 ms-2 text-gray-500">{formatTime( updatedAt)}</h3>
              </div>
              <h2 className={` p-1 text-[1rem] font-thin text-gray-800`}>{text}</h2>
